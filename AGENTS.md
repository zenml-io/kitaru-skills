...
- Keep the expanded tour evidence-led: survey every one of the 30 sessions with
  ...
  and inspect complete traces until a meaningful five-case selection is
  supported or the population is exhausted. Require all five human verdicts
  before creating a cohort or behavior evaluator; written answers remain
  optional context.
