...
useful through the canonical example, continue with the `kitaru-guided-tour`
...
1. Resolve a reachable project root. For a frontend starter or `template`
   ...
   canonical example. If no example directory is reachable, report the incomplete handoff
